...
const cards = [
  {
    ...
    headline: 'COLOR ALL<br/>48 FLAGS',
    sub: 'Every World Cup 2026 team ⚽',
  ...
  },
  {
    ...
    headline: 'BEAT THE<br/>CLOCK ⏱️',
    sub: 'Guess the flag in 12 seconds',
  ...
  },
  {
    ...
    headline: 'THE REAL 2026<br/>SCHEDULE',
    sub: 'All 104 matches · daily challenges',
  ...
  },
  {
    ...
    headline: 'FILL YOUR<br/>PASSPORT',
    sub: 'Badges · streaks · country stamps',
  ...
  },
  {
    ...
    headline: 'PLAY. LEARN.<br/>WIN. 🏆',
    sub: 'Capitals · continents · football lore',
